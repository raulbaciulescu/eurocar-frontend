...
const SpecialCarsPage = () => {
    const [index, setIndex] = useState(0);
    const [images, setImages] = useState(null);
    const galleria = useRef(null);

    const cars = [
        "/images/specialcar-with-frame1.png",
        "/images/specialcar-with-frame2.png",
    ];
                ...
                <div className="w-full mt-20 flex items-center flex-wrap">
                    ...
                    <div className="lg:w-3/6 w-full text-white lg:order-1 md:order-1 items-center ">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="lg:text-xl mt-6 cursor-pointer underline"
                               onClick={() => galleria.current.show()}>
...
export default SpecialCarsPage;